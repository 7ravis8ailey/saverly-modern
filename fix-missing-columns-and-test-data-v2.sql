...
-- ========================================
-- PART 3: Add featured column to coupons (using correct name)
-- ========================================

-- Check if we need to add or rename the featured column
DO $$
BEGIN
    -- If is_featured exists but featured doesn't, add featured as an alias
    IF EXISTS (
        ...
        -- Add featured column that mirrors is_featured
        ALTER TABLE public.coupons ADD COLUMN featured BOOLEAN DEFAULT false;
        UPDATE public.coupons SET featured = is_featured;
    ELSIF NOT EXISTS (
        SELECT 1 FROM information_schema.columns 
        WHERE table_name = 'coupons' 
        AND column_name = 'is_featured' 
        ...
        -- Neither exists, add is_featured
        ALTER TABLE public.coupons ADD COLUMN is_featured BOOLEAN DEFAULT false;
    END IF;
END $$;

-- ========================================
-- PART 4: Create Test Coupons for Testing
-- ========================================
...
-- ========================================
-- PART 5: Update Sample User Profiles
-- ========================================
