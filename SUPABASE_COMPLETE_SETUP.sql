-- ========================================================================
-- SAVERLY MODERN v2.0.0 - COMPLETE SUPABASE DATABASE SETUP
-- ========================================================================
...
INSERT INTO public.users (id, email, full_name, is_admin, subscription_status, created_at) 
VALUES (
...
INSERT INTO public.businesses (id, owner_id, name, description, category, address, city, state, zip_code, latitude, longitude, phone, email, active) VALUES
('10000000-0000-0000-0000-000000000001'::uuid, '00000000-0000-0000-0000-000000000001'::uuid, 'Downtown Coffee Corner', 'Premium coffee and fresh pastries in the heart of downtown', 'Food & Beverage', '123 Main St', 'Portland', 'OR', '97201', 45.5152, -122.6784, '(503) 555-0123', 'info@coffeecorner.com', true),
('10000000-0000-0000-0000-000000000002'::uuid, '00000000-0000-0000-0000-000000000001'::uuid, 'Fresh Market Grocery', 'Local organic groceries and fresh produce', 'Retail', '456 Oak Avenue', 'Portland', 'OR', '97202', 45.5020, -122.6590, '(503) 555-0456', 'hello@freshmarket.com', true),
('10000000-0000-0000-0000-000000000003'::uuid, '00000000-0000-0000-0000-000000000001'::uuid, 'Zen Yoga Studio', 'Mindful yoga classes for all levels', 'Health & Wellness', '789 Pine Street', 'Portland', 'OR', '97203', 45.5289, -122.6765, '(503) 555-0789', 'namaste@zenyoga.com', true),
('10000000-0000-0000-0000-000000000004'::uuid, '00000000-0000-0000-0000-000000000001'::uuid, 'Bella Beauty Salon', 'Full-service hair and beauty treatments', 'Personal Services', '321 Elm Drive', 'Portland', 'OR', '97204', 45.5445, -122.6598, '(503) 555-0321', 'book@bellabeauty.com', true),
('10000000-0000-0000-0000-000000000005'::uuid, '00000000-0000-0000-0000-000000000001'::uuid, 'Epic Games Arcade', 'Retro and modern gaming experience', 'Entertainment & Recreation', '654 Maple Lane', 'Portland', 'OR', '97205', 45.5183, -122.6742, '(503) 555-0654', 'play@epicgames.com', true);

-- Insert sample coupons
INSERT INTO public.coupons (id, business_id, title, description, coupon_type, discount_percentage, minimum_purchase, terms_conditions, usage_limit_type, max_redemptions, end_date, active) VALUES
('20000000-0000-0000-0000-000000000001'::uuid, '10000000-0000-0000-0000-000000000001'::uuid, '20% Off Your Order', 'Get 20% off any coffee or pastry purchase', 'percentage', 20, 5.00, 'Valid for dine-in or takeout. Cannot be combined with other offers.', 'unlimited', 1000, NOW() + INTERVAL '30 days', true),
('20000000-0000-0000-0000-000000000002'::uuid, '10000000-0000-0000-0000-000000000002'::uuid, '$10 Off Groceries', 'Save $10 on grocery purchases over $50', 'fixed_amount', null, 50.00, 'Valid on regular priced items only.', 'monthly', 500, NOW() + INTERVAL '60 days', true),
('20000000-0000-0000-0000-000000000003'::uuid, '10000000-0000-0000-0000-000000000003'::uuid, 'Buy One Class, Get One Free', 'Purchase any yoga class and get another class free', 'bogo', null, 0.00, 'Free class must be used within 30 days.', 'once', 100, NOW() + INTERVAL '45 days', true),
('20000000-0000-0000-0000-000000000004'::uuid, '10000000-0000-0000-0000-000000000004'::uuid, 'Free Hair Consultation', 'Complimentary hair consultation with any service', 'free_item', null, 75.00, 'Must book consultation in advance.', 'once', 50, NOW() + INTERVAL '90 days', true),
('20000000-0000-0000-0000-000000000005'::uuid, '10000000-0000-0000-0000-000000000005'::uuid, '25% Off Gaming Sessions', 'Get 25% off any gaming session over 2 hours', 'percentage', 25, 20.00, 'Valid Monday-Thursday only.', 'weekly', 200, NOW() + INTERVAL '14 days', true);

-- ========================================================================
-- 13. ANALYTICS VIEWS (OPTIONAL)
-- ========================================================================
...
-- ========================================================================
-- 
-- Your Saverly Modern v2.0.0 database is now ready!
-- 
-- Next steps:
-- 1. Test the connection from your app
-- 2. Create your first user account through the app
-- 3. Start adding businesses and coupons
-- 
-- Admin credentials (once you sign up with this email):
